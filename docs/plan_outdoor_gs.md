...
### 1.6 2026-06-11(続): robotics 応用 3 本 — ROS 2 localizer ノード + Isaac Sim エクスポート + GS カメラシミュレータ
...
残る robotics 応用弾(未着手、ユーザー判断待ち): nav2 OccupancyGrid エクスポート、変化検出(inspection)。
